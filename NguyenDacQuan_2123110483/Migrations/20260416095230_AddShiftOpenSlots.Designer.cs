...
namespace NguyenDacQuan_2123110483.Migrations
{
    ...
    [Migration("20260416095230_AddShiftOpenSlots")]
    partial class AddShiftOpenSlots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoffeeHRM.Models.Schedule", b =>
                {
                    ...
                    b.Property<int?>("OpenShiftSlotId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoffeeHRM.Models.ShiftOpenSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BranchId", "ShiftId", "SlotDate")
                        .IsUnique();

                    b.ToTable("ShiftOpenSlots");
                });
            ...
            modelBuilder.Entity("CoffeeHRM.Models.Schedule", b =>
                {
                    ...
                    b.HasOne("CoffeeHRM.Models.ShiftOpenSlot", "OpenShiftSlot")
                        .WithMany("Schedules")
                        .HasForeignKey("OpenShiftSlotId")
                        .OnDelete(DeleteBehavior.SetNull);
